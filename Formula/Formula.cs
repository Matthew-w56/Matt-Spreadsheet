...
//WHERE I AM NOW
// Formula should be mostly done. The equality checks and ToString need revision and completion.
// I stopped because I was unsure how or whether to access the tokens array in the other formula.
//      Possible other way would be to compare ToString, and just make sure that ToString ipmlements
//      the Double.Parse().ToString() idea.
...
namespace SpreadsheetUtilities {
    ...
    public class Formula {
        ...
        /// <summary>
        /// Returns a copy of this formula's list of tokens
        /// </summary>
        /// <returns>IEnumerable<string>.  List of tokens</returns>
        ...
        {
            //Because we can assume that 'this' is not null, we can return false here
            if (obj == null || obj is not Formula) return false;
            Formula other = (Formula)obj;
            /*if (other.tokens)  TODO: AFTER ANSWER FROM CLASS
            for (int i = 0; i < )*/
            return true;
        }
		...
		static double ApplyOperation(double val1, string op, double val2) {
